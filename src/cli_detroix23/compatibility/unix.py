"""
# CLI - Compatibility.
src/cli_detroix23/compatibility/unix.py

Usage of `termios` and `tty`.
...
if os.name != "posix":
    raise OSError("Tried to open an Unix-only script (src/cli_detroix23/compatibility/unix.py).")
...
CC: Final[list[str]] = [
    ...
    "VMIN", "VQUIT", "VREPRINT", "VSTART", "VSTATUS", 
